...
const RecentActivity = () => {
  ...
  return (
    <div className='w-1/6 h-[60%] border border-gray-400 rounded-2xl text-center flex flex-col pt-2.5'>
        ...
        <div className='w-full h-full mt-5'>
           {
                ...
                queriesCreated.map((q:any,i:number) => (
                    <button key={i} className='w-[80%] h-[35px] rounded-md bg-gray-200 hover:bg-blue-600 text-sm'>
                        {q.owner} - {q.repo}
                    </button>
                ))
            }
